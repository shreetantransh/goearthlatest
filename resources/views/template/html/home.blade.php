                    ...
                    <div class="tiva-slideshow-wrapper">
                        <div id="tiva-slideshow" class="nivoSlider">
                            @foreach ($banners as $banner)
                                <a href="#">
                                    <img class="img-responsive" src="{{ $banner->getImage(1920, 500) }}"
                                         alt="Slideshow Image">
                                </a>
                            @endforeach
                        </div>
                            ...
                            <ul>
                                @foreach($categories as $key => $category)
                                    <li data-toggle="tab" class="{{ $key == 0 ? 'active' : '' }}">
                                        <a data-toggle="tab" href="#{{ $category->slug }}" id="home-category-anchor"
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 top-left text-center">
                                <div class="intro-item">
                                    ...
                                    <h4>Always Fresh</h4>
                                    <p>Unlike artificially preserved foods, organic food travels from farm to kitchen
                                        faster.</p>
                                </div>
                            </div>
